...
const MenuCard = ({ selectedLabel, mealList }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row space-y-4 md:gap-8 md:space-x-4 md:justify-center ">
      <div
        className="md:w-3/4 lg:w-2/3 xl:w-1/2 rounded-lg shadow-lg mt-8 md:mx-auto lg:mx-0 bg-gray-200"
        style={{
          background:
            'bg-gray-400',
        }}
      >
        ...
        <div className="flex mt-4">
          <ReactPaginate
            ...
            activeClassName={'bg-grey-200 text-blue-500 px-4 py-2 rounded-lg'}
          />
        </div>
      </div>
